...
export function CompanyRegister() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const formsPartnerCollectionRef = collection(firestore, "formsPartner")
            const formDataPartner = {
            ...
            const docRef = await addDoc(formsPartnerCollectionRef, formDataPartner);
